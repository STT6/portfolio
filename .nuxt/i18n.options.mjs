export const localeCodes = ["sl","en"]
...
export const resolveNuxtI18nOptions = async (context) => {
 ...
 const vueI18nConfigLoader = async (loader) => {
  ...
  const vueI18n = await vueI18nConfigLoader((() => import("../i18n.config.ts?hash=98563ad1&config=1" /* webpackChunkName: "__i18n_config_ts_98563ad1" */)))
...
export const nuxtI18nInternalOptions = Object({__normalizedLocales: [Object({"code":"sl","name":"Slovenščina","iso":"sl_SI","files":[],"hashes":[],"types":[]}),Object({"code":"en","name":"English","iso":"en_EN","files":[],"hashes":[],"types":[]})]})
