import { hasInjectionContext, getCurrentInstance, version, unref, inject, defineComponent, h, onUnmounted, ref, computed, watch, Fragment, useSSRContext, createApp, reactive, markRaw, effectScope, isRef, isReactive, toRef, toRaw, nextTick, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, getCurrentScope, onScopeDispose, Text, defineAsyncComponent, toRefs, isShallow, withCtx, mergeProps, triggerRef, watchEffect, Suspense, Transition, createTextVNode, resolveComponent } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/ofetch/dist/node.mjs';
...
import { getActiveHead, CapoPlugin } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRouter as useRouter$1, useRoute as useRoute$1, RouterView } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestHeaders } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL, isEqual } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/ufo/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/vue-devtools-stub/dist/index.mjs';
import { CoreWarnCodes, CoreErrorCodes, registerMessageCompiler, compile, registerMessageResolver, resolveValue, registerLocaleFallbacker, fallbackWithLocaleChain, setDevToolsHook, createCompileError, DEFAULT_LOCALE as DEFAULT_LOCALE$1, updateFallbackLocale, NUMBER_FORMAT_OPTIONS_KEYS, DATETIME_FORMAT_OPTIONS_KEYS, setFallbackContext, createCoreContext, clearDateTimeFormat, clearNumberFormat, setAdditionalMeta, getFallbackContext, NOT_REOSLVED, isTranslateFallbackWarn, isTranslateMissingWarn, parseTranslateArgs, translate, MISSING_RESOLVE_VALUE, parseDateTimeArgs, datetime, parseNumberArgs, number, isMessageAST } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@intlify/core-base/dist/core-base.mjs';
import { VueDevToolsLabels, VueDevToolsPlaceholders, VueDevToolsTimelineColors } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@intlify/vue-devtools/dist/vue-devtools.mjs';
import { parse, serialize } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/cookie-es/dist/index.mjs';
import isHTTPS from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/is-https/dist/index.mjs';
import { resetCount, createConfig, getNode, clearErrors, setErrors, submitForm, reset, createClasses, generateClassList, createMessage, error, createNode, warn as warn$2, watchRegistry, isNode, sugar, isDOM, isComponent, isConditional, compile as compile$1 } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/core/dist/index.mjs';
import { extend, empty, has, eq, cloneAny, shallowClone, undefine, camel, kebab, nodeProps, only, except, oncePerTick, slugify, isObject as isObject$2, token, isPojo } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/utils/dist/index.mjs';
import { createSection, createLibraryPlugin, inputs, runtimeProps } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/inputs/dist/index.mjs';
import * as defaultRules from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/rules/dist/index.mjs';
import { createValidationPlugin } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/validation/dist/index.mjs';
import { en, sl, createI18nPlugin } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/i18n/dist/index.mjs';
import { generateClasses, createThemePlugin } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/themes/dist/index.mjs';
import { createObserver } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@formkit/observer/dist/index.mjs';
import dayjs from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/dayjs/dayjs.min.js';
import sl$1 from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/dayjs/locale/sl.js';
import { createGtm } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/@gtm-support/vue-gtm/dist/index.js';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file://C:/Programming/Projects/LearningGSAP/portfolio/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-c3249381.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/projects-25d0c077.mjs').then((m) => m.default || m)
  },
  {
    name: "projects",
    path: "/projects",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/test-68bdeaa2.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
  ...
  {
    name: "propercore-page___sl",
    path: "/sl/page/:slug",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-6784b317.mjs').then((m) => m.default || m)
  },
  {
    ...
    return new Promise((resolve2) => {
      setTimeout(() => {
        ...
        if (!to.hash) {
          ...
          const top = window.pageYOffset + ((_b = (_a = document == null ? void 0 : document.getElementById(to.hash.substring(1))) == null ? void 0 : _a.getBoundingClientRect()) == null ? void 0 : _b.top) || 0;
          resolve2({
            left: 0,
            top: top || 0
          });
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  const vueI18n = await vueI18nConfigLoader(() => import(
    './_nuxt/i18n.config-d8e94c29.mjs'
    /* webpackChunkName: "__i18n_config_ts_98563ad1" */
  ));
  nuxtI18nOptions.vueI18n = vueI18n;
  (_a = nuxtI18nOptions.vueI18n).messages ?? (_a.messages = {});
  nuxtI18nOptions.locales = [Object({ "code": "sl", "name": "Slovenščina", "iso": "sl_SI", "files": [], "hashes": [], "types": [] }), Object({ "code": "en", "name": "English", "iso": "en_EN", "files": [], "hashes": [], "types": [] })];
...
const nuxtI18nInternalOptions = Object({ __normalizedLocales: [Object({ "code": "sl", "name": "Slovenščina", "iso": "sl_SI", "files": [], "hashes": [], "types": [] }), Object({ "code": "en", "name": "English", "iso": "en_EN", "files": [], "hashes": [], "types": [] })] });
...
function useInput(props, context, options = {}) {
  ...
  const node = createNode(extend(config2 || {}, {
    ...
    value,
    parent,
    plugins: (config2.plugins || []).concat((_a = props.plugins) !== null && _a !== void 0 ? _a : []),
    config: props.config || {},
    props: initialProps,
    index: props.index,
...
const dayjs_pGiXRjcsJO = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  dayjs.locale(sl$1);
...
const init_server_p4TXvyjLiW = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
  const coreStore = useCoreStore();
  [__temp, __restore] = executeAsync(() => coreStore.initApp()), await __temp, __restore();
});
const vue_gtm_yUJQMSAo2j = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  if ((/* @__PURE__ */ useRuntimeConfig()).public.GOOGLE_TAG_MANAGER_ID) {
    nuxtApp.vueApp.use(
      createGtm({
        id: (/* @__PURE__ */ useRuntimeConfig()).public.GOOGLE_TAG_MANAGER_ID,
        defer: true,
...
const layouts = {
  default: () => import('./_nuxt/default-55454485.mjs').then((m) => m.default || m),
  mobile: () => import('./_nuxt/mobile-3dc97073.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-65532e2f.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-a9ce9040.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-30b82b6e.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRequestFetch as a, useRuntimeConfig as b, createError as c, useRoute as d, entry$1 as default, useRouter as e, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useNuxtApp as u };
